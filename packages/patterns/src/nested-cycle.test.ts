...
describe("NestedCycle", () => {
  describe("constructor", () => {
    it("wraps a single value into [[value]]", () => {
      const cycle = new NestedCycle<number>(5);
      expect(cycle.current).toEqual([[5]]);
    });

    it("wraps an array into [array]", () => {
      const cycle = new NestedCycle<number>([1, [2, 3]]);
  ...
  describe("pattern", () => {
    it("sets the cycle and returns this", () => {
      const cycle = new NestedCycle<number>(0);
  ...
  describe("fast", () => {
    it("compresses the cycle", () => {
      const cycle = new NestedCycle<number>(0, 0);
      cycle.pattern([1], [2], [3], [4]);
      cycle.fast(2);
      expect(cycle.current).toEqual([
        [1, 2],
    ...
    it("returns this unchanged when nullValue is undefined", () => {
      const cycle = new NestedCycle<number>([1, 2]);
      cycle.fast(2);
  ...
  describe("slow", () => {
    it("expands the cycle with null values", () => {
      const cycle = new NestedCycle<number>([1, 2], 0);
      cycle.slow(2);
      expect(cycle.current).toEqual([
        [1, 0],
        [2, 0],
  ...
  describe("euclid", () => {
    it("applies a euclidean pattern", () => {
      const cycle = new NestedCycle<number>([1, 2, 3], 0);
      cycle.euclid(2, 4);
  ...
  describe("hex", () => {
    it("applies a hex pattern", () => {
      const cycle = new NestedCycle<number>([1, 2, 3, 4], 0);
      cycle.hex("9");
  ...
  describe("at", () => {
    ...
    it("falls back to nullValue for missing elements", () => {
      const cycle = new NestedCycle<number>(0, -1);
      cycle.clear();
